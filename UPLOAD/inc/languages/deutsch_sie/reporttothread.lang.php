<?php
/*
* Report to Thread - 1.7 Language File German (formal)
...
$l['setting_reporttothread_enable_desc'] = "Wählen Sie JA um die Funktion von Report to Thread einzuschalten!";

$l['setting_reporttothread_fid'] = "Forum für die Meldungen";
$l['setting_reporttothread_fid_desc'] = "Wählen Sie das Forum aus, in dem die Meldungens-Threads erstellt werden sollen.";

$l['setting_reporttothread_modcp'] = "ModCP-Infobar für Meldungen deaktivieren?";
$l['setting_reporttothread_modcp_desc'] = "Wählen Sie JA um die ModCP Infobar für die Meldungen auszuschalten, für die ein Thread erstellt wurde!";

$l['setting_reporttothread_type'] = "Threads erstellen bei Meldungen von:";
$l['setting_reporttothread_type_desc'] = "Wählen Sie die Arten der Meldungen aus, wofür ein Diskussionthread erstellt werden soll (Mehrfachauswahl möglich)";
...
$l['setting_reporttothread_autoclose_desc'] = "Wählen Sie JA um diese Funktion zu aktivieren!";

$l['setting_reporttothread_autoclose_uid'] = "BenutzerID der Schließungsnachricht";
$l['setting_reporttothread_autoclose_uid_desc'] = "Wählen Sie hier die ID des Benutzers aus, mit der die Schließungsnachricht eingefügt wird.";
...
$l['error_setting_reporttothread_fid_no_forum_selected'] = "Sie müssen ein Forum auswählen, in dem die Themen erstellt werden können!";
$l['error_setting_reporttothread_fid_category_selected'] = "Sie müssen ein Forum auswählen und keine Kategorie!";
...
$l['reporttothread_subject'] = "{1} in {3} gemeldet von {2}";
